...
export const es: TranslationKeys = {
    ...
    home: {
        ...
        history: 'Visto recientemente',
        noHistory: 'Sin historial aún. Explora guías para comenzar.',
    },
    guide: {
        step: 'Paso {{number}}',
        done: 'Hecho',
    ...
    library: {
        ...
        favorites: 'Favoritos',
        noFavorites: 'Sin favoritos. Toca el corazón en una guía para guardarla.',
    },
    favorites: {
        title: 'Favoritos',
    ...
    common: {
        ...
        searchByVoiceHint: 'Toca para hablar tu búsqueda',
    },
};
